...
<body class="bg-gradient-to-br from-blue-50 to-slate-100 min-h-screen p-4 md:p-6">
    <div class="max-w-6xl mx-auto shadow-2xl p-4 rounded-md">
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl md:text-3xl font-bold text-slate-900">Edit User</h1>
                    </div>
                </div>
                <div class="flex items-center gap-3">
        ...
        <!-- Form Container -->
        <form action="{{ route('manage-admin.update', $user->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-500 mt-0.5">Update user details and credentials</p>
                            </div>
                        </div>
                ...
                <div class="p-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input type="text" name="name" value="{{ $user->name }}" required class="w-full rounded-lg border border-slate-300 bg-white px-4 py-3 text-sm input-focus transition-all duration-200" placeholder="Enter full name">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input type="email" name="email" value="{{ $user->email }}" required class="w-full rounded-lg border border-slate-300 bg-white px-4 py-3 text-sm input-focus transition-all duration-200" placeholder="email@example.com">
                                <div class="absolute right-3 top-3 text-slate-400">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input type="password" name="password" id="password" class="w-full rounded-lg border border-slate-300 bg-white px-4 py-3 text-sm input-focus transition-all duration-200" placeholder="Leave blank to keep current password">
                                <div class="absolute right-3 top-3 text-slate-400">
                            ...
                            <div class="text-xs text-slate-500 mt-2 space-y-1">
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="h-1.5 w-1.5 rounded-full bg-slate-300"></span>
                                    <span>Minimum 8 characters if changing</span>
                                </div>
                            </div>
                        </div>
